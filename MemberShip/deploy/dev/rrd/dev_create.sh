...
if [ ! -f "/home/m3/dev/rrd/test1_load.rrd" ]; then
/usr/bin/rrdtool create "/home/m3/dev/rrd/test1_load.rrd" \
		--step 60 \
...
if [ ! -f "/home/m3/dev/rrd/test1_gateway.rrd" ]; then
/usr/bin/rrdtool create "/home/m3/dev/rrd/test1_gateway.rrd" \
		--step 60 \
...
if [ ! -f "/home/m3/dev/rrd/test1_room.rrd" ]; then
/usr/bin/rrdtool create "/home/m3/dev/rrd/test1_room.rrd" \
		--step 60 \
  ...
  do
    if [ ! -f "/home/m3/dev/rrd/test1_"$PROCESS".rrd" ]; then
    /usr/bin/rrdtool create "/home/m3/dev/rrd/test1_"$PROCESS".rrd" \
        --step 60 \
...
if [ ! -f "/home/m3/dev/rrd/test1_mem.rrd" ]; then
/usr/bin/rrdtool create "/home/m3/dev/rrd/test1_mem.rrd" \
        --step 60 \
...
if [ ! -f "/home/m3/dev/rrd/test1_dsk.rrd" ]; then
/usr/bin/rrdtool create "/home/m3/dev/rrd/test1_dsk.rrd" \
        --step 60 \
        "DS:usage:GAUGE:600:0:U" \
        "DS:free:GAUGE:600:0:U" \
        "RRA:LAST:0.5:1:144000" \
...
if [ ! -f "/home/m3/dev/rrd/test1_redis.rrd" ]; then
/usr/bin/rrdtool create "/home/m3/dev/rrd/test1_redis.rrd" \
        --step 60 \
...
if [ ! -f "/home/m3/dev/rrd/test1_process.rrd" ]; then
/usr/bin/rrdtool create "/home/m3/dev/rrd/test1_process.rrd" \
        --step 60 \
