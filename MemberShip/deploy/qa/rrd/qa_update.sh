...
/usr/bin/rrdtool update "/neowiz/msh/rrd/mox623_load.rrd" N:$DATA

/usr/bin/rrdtool update "/neowiz/msh/rrd/mox623_mem.rrd" N:`free -b |grep cache:|cut -d":" -f2|awk '{print $1 ":" $2}'`

/usr/bin/rrdtool update "/neowiz/msh/rrd/mox623_dsk.rrd" N:`df -B 1 |grep /dev/sda2|awk '{print $3 ":" $4}'`
...
/usr/bin/rrdtool update "/neowiz/msh/rrd/mox623_process.rrd" N:$GATEWAY_MEMORY:$ROOM_MEMORY:$STAGE1_MEMORY:$STAGE2_MEMORY:$STAGE3_MEMORY:$STAGE4_MEMORY
